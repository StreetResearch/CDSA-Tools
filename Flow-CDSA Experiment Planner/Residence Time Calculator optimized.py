...
# make it loop-able
new_iteration = True
iterate_single_parameter = False
run_index = 1
while new_iteration == True:
    ...
    if to_calc == 'tr':
        if iterate_single_parameter == True:
            print('Which parameter do you wish to change?')
            print("press 'i' to change the reactor ID")
            print("press 'l' to change the reactor length")
            print("press 't' to change the total no. of input streams and their flow rates")
            next_parameter = input('Which parameter do you wish to change?')
            if next_parameter == 'i':
                reactor_ID = float(input('What is the inner diameter of your tubing in mm? '))
            elif next_parameter == 'l':
                reactor_length = float(input('What is the length of your reactor in cm? '))
            elif next_parameter == 't':
                ...
                print('Error, please specify which variable to change')
        elif iterate_single_parameter == False:
            reactor_ID = float(input('What is the inner diameter of your tubing in mm? '))
            reactor_length = float(input('What is the length of your reactor in cm? '))
            total_streams = float(input('How many input streams do you have? '))
            total_flow_rate, streamA_flow_rate, streamB_flow_rate, streamA_flow_ratio, streamB_flow_ratio = get_combined_fr(total_streams)
        ...
        if iterate_single_parameter == True:
            print('Which parameter do you wish to change?')
            print("press 'tr' to change the residence time")
            print("press 'i' to change the reactor ID")
            print("press 't' to change the total no. of input streams and their flow rates")
            next_parameter = input('Which parameter do you wish to change?')
            if next_parameter == 'tr':
    ...
    if iterate == 'y':
        ...
        #see if they want to vary one parameter, or begin again
        next_run = input("Would you like to vary one parameter, or multiple? Press '1' for one, and 'm' for multiple. ")
        if next_run == '1':
            iterate_single_parameter = True
        elif next_run == 'm':
            iterate_single_parameter = False
        else:
            print("Error, please select either '1' to vary 1 parameter, or 'm' to vary many")
